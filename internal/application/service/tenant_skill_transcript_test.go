...
func (s *transcriptStreams) AppendSteerEvents(context.Context, string, string, []interfaces.StreamEvent) error {
	return nil
}
...
func (s *transcriptStreams) DeleteSteerEvent(context.Context, string, string, string) (bool, error) {
	return false, nil
}
func (s *transcriptStreams) SetLiveRun(context.Context, string, string, string) error   { return nil }
func (s *transcriptStreams) ClaimLiveRun(context.Context, string, string, string) error { return nil }
func (s *transcriptStreams) GetLiveRun(context.Context, string) (string, string, error) {
	return "", "", nil
}
func (s *transcriptStreams) ClearLiveRun(context.Context, string, string) error { return nil }
