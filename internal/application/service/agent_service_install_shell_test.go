...
func TestInstallerAgentGetsTheRootShellWithTheSkillsRoot(t *testing.T) {
	...
	config.EnableSkillInstallMode(types.BuiltinSkillInstallerID, sandbox.SkillsImageRoot+"/sk-1")
...
func TestInstallModeIsRefusedToEveryAgentButTheInstaller(t *testing.T) {
	...
	config.EnableSkillInstallMode("some-tenant-agent", sandbox.SkillsImageRoot+"/sk-1")
...
func TestInstallerAgentConfigTurnsOnInstallMode(t *testing.T) {
	...
	}, "cfg-1", sandbox.SkillsImageRoot+"/sk-1")
