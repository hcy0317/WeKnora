...
type AgentConfig struct {
	...
	HistoryTurns            int           `json:"history_turns,omitempty"`              // Maximum previous turns to include when multi-turn is enabled
...
type AgentState struct {
	...
	TurnUsage            TokenUsage      `json:"turn_usage"`     // LLM usage accumulated across every round of this turn
}
