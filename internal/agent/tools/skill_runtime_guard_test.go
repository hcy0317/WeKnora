...
func TestMissingSkillPackageGuidanceUsesTheUnifiedExecutor(t *testing.T) {
	...
	require.Contains(t, hint, "$WEKNORA_SKILL_PACKAGE_DIR")
	...
	require.Contains(t, hint, "/workspace/.skill-packages")
}
...
func TestSkillOnDemandInstallHintSkipsFrozenInstaller(t *testing.T) {
	hint := skillOnDemandInstallHint(
		"律师助手", "scripts/install_deps.py", "word dependency failed", "No module named pip\n",
	)
...
func TestSkillMissingPackageHintPointsToSessionOverlay(t *testing.T) {
