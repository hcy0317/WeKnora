...
func TestResolveProvider(t *testing.T) {
	cases := []struct {
		...
		{"openai model names do not change adapter", provider.ProviderOpenAI, "gpt-5", baseProvider{}},
		{"azure non-reasoning", provider.ProviderAzureOpenAI, "gpt-4", azureProvider{}},
		{"azure model names do not change adapter", provider.ProviderAzureOpenAI, "gpt-5-mini", azureProvider{}},
