...
func (s *stubStreamManager) AppendSteerEvents(context.Context, string, string, []interfaces.StreamEvent) error {
	return nil
}
...
func (s *stubStreamManager) DeleteSteerEvent(context.Context, string, string, string) (bool, error) {
	return false, nil
}

func (s *stubStreamManager) SetLiveRun(context.Context, string, string, string) error { return nil }
...
func (s *stubStreamManager) ClearLiveRun(context.Context, string, string) error { return nil }
