export default {
  ...
  agentEditor: {
    ...
    desc: {
      ...
      conversationSectionAgent: 'Smart reasoning is always multi-turn. History stays within the model context window and the configured turn limit; older turns are summarized automatically when the context window fills.',
