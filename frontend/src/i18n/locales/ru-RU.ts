export default {
  ...
  agentEditor: {
    ...
    desc: {
      ...
      conversationSectionAgent: 'Умные рассуждения всегда многооборотные. История ограничена контекстным окном модели и заданным числом ходов; при заполнении окна ранние ходы автоматически сжимаются в сводку.',
  ...
  kbSettings: {
    parser: {
      ...
      standby: 'Ожидание (управляется движком)',
      starting: 'Запуск',
